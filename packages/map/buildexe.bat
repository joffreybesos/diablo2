...
docker cp dummy:/build/bin/d2-map.exe ./d2lod-map.exe
docker rm -f dummy

d2lod-map.exe "E:/Dev/d2-mapserver/game" --seed 12345 --difficulty 2 --map 1 --edge --nomapjson --output-folder E:/Dev/diablo2/packages/map/bin